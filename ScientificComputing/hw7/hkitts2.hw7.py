...
#  block also.
#####################################################################################
#  R     - is the distance to the from the observing point (origin) and the satellite
#  theta - is the polar angle to R
#		   together R and theta form the polar cordinates for the satellite
#  C     - constant stored in x[0]
#  e     - the eccentricity of the orbit, stored in x[1]
#  alpha - constant stored in x[2]
#  x is the initial guess for the satillites location
#  the predictions from NR are then stored in x
#
#  The equation above is stored in the function F. The below data pairs are in the 
#  function where the first pair is F[0] and the next is F[1] and so on.
#####################################################################################
